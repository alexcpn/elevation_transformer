...
try:
    ...
    raise Exception(
        f"ITM extension module not available. Please compile it using:\n"
        f"python setup.py build_ext -i {e}"
    )
...
def point_to_point(
    ...
    if np.isscalar(reliabilities):
        ...
        return itm_its.point_to_point_rels(
            its_elev,
            height_tx,
            height_rx,
            dielectric,
